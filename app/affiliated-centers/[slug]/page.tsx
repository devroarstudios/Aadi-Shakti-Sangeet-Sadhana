...
export default async function CenterPage({
  ...
  const center = affiliatedCenters.find((item) => item.slug === slug);
      ...
      <main className="center-page">
        ...
        <section className="center-hero">
          <div className="center-hero-inner">
            ...
            <div className="center-content">
              <span className="center-eyebrow">AFFILIATED center</span>
        ...
        <section className="center-gallery">
          <div className="center-gallery-grid">
            {center.images.map((image, index) => (
              <div className="center-gallery-item" key={index}>
                <img src={image} alt={`${center.name} - ${index + 1}`} />
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="center-faculty">
          <div className="center-faculty-inner">
            <h3 className="center-faculty-title">Center Head</h3>

            {center.faculty.map((person) => (
              <div className="center-faculty-card" key={person.name}>
                {/* Artist Image */}
                ...
                <div className="center-faculty-content">
                  ...
                  {person.achievements.length > 0 && (
                    <div className="center-faculty-achievements">
                      <h5>Major Achievements & Highlights</h5>
